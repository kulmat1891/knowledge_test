...
public class AdminDashboardFXMLController implements Initializable {
    ...
    @FXML
    public TableColumn<User, String> phonecol;
    @FXML
    public TableColumn<User, Character> gendercol;
    @FXML
    public TableColumn<User, String> countrycol;
    @FXML
    ...
    private void setupBarChart() {
        Map<Quiz, Integer> data = Quiz.getUserCount();
    ...
    private void collectStudents() {
        List<User> users = QuizResult.getUsers(this.selectedQuiz);
    ...
    public void onRowClick(MouseEvent mouseEvent) {
        ...
        List result = QuizResult.getResult(user);
    ...
    private void renderPieChart(List<QuizResult> quizResults, Integer numberOfTotalQuestions) {
        ...
        for (QuizResult quizResult : quizResults) {
            ...
            int wrigth = quizResult.getWrightAnswers();
            int wrong = numberOfTotalQuestions - wrigth;
            pieChart.setTitle("Attemped On :" + quizResult.getTimestamp());
            pieChart.getData().add(new PieChart.Data
                    ("Right Answers (" + wrigth + ")"
                            , wrigth));
            pieChart.getData().add(new PieChart.Data
                    ("Wrong Answers (" + wrong + ")"
                            , wrong));
